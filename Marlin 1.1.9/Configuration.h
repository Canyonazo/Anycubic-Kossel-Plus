...
#define STRING_CONFIG_H_AUTHOR "(Paul_GD & ADP, 2018/08/14)" // Who made the changes.
...
#define DELTA
  ...
  #define DELTA_HEIGHT 295.20 // get this value from auto calibrate
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 80, 106 }  // default steps per unit for Kossel (GT2, 20 tooth)
